      ...
      <Container>
        <div className="header-inner">
          <a href="#" className="header-logo" aria-label="VIP Construtora">
            <img src={window.__resources.logoHeader} alt="VIP Construtora" style={{ height: "100px", objectFit: "cover", width: "120px" }} />
          </a>
...
/* ----- Founders ----- */
const FOUNDERS = [
  { photo: window.__resources.germano, name: "Germano", role: "Sócio-fundador", pos: "center 28%" },
  { photo: window.__resources.vivian, name: "Vivian", role: "Sócia-fundadora", pos: "center 18%" },
];
...
const Hero = () =>
  <section className="hero" data-screen-label="01 Hero">
    <div className="hero-photo">
      <img src={window.__resources.heroBg} alt="Fachada de uma casa moderna entregue pela VIP Construtora" />
    </div>
    <Container>
...
const DELIVERIES = [
  { poster: window.__resources.delivery1, family: "Família Souza", city: "Quixeramobim — CE", project: "Casa entregue em Mar/2025", duration: "1:24" },
  { poster: window.__resources.delivery2, family: "Família Ferreira", city: "Senador Pompeu — CE", project: "Casa entregue em Nov/2024", duration: "2:08" },
  { poster: window.__resources.delivery3, family: "Família Lima", city: "Boa Viagem — CE", project: "Casa entregue em Ago/2024", duration: "1:47" },
  { poster: window.__resources.delivery4, family: "Família Santos", city: "Mombaça — CE", project: "Casa entregue em Mai/2024", duration: "2:32" },
  { poster: window.__resources.delivery5, family: "Família Oliveira", city: "Banabuiú — CE", project: "Casa entregue em Fev/2024", duration: "1:58" },
  { poster: window.__resources.delivery6, family: "Família Costa", city: "Quixeramobim — CE", project: "Casa entregue em Out/2023", duration: "2:15" },
];
    ...
    <Container>
      <div className="footer-inner">
        <div className="footer-brand">
          <img src={window.__resources.logoFooter} alt="VIP Construtora" />
          <p>
